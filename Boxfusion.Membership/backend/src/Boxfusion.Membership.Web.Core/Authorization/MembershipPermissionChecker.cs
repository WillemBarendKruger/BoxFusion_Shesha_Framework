...
namespace Boxfusion.Membership.Common.Authorization
{
    ...
    /// </summary>
    public class MembershipPermissionChecker : ICustomPermissionChecker, IMembershipPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public MembershipPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
