...
using Boxfusion.Membership.Tests.DependencyInjection;
using Shesha;
...
namespace Boxfusion.Membership.Common.Tests
{
    [DependsOn(
    ...
    public class MembershipCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public MembershipCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
